# 安静闹钟 v1.0 (Desktop Visual Timer)

一个现代化、专业级的桌面闹钟和定时器应用，采用先进的UI设计系统，支持单次和重复性闹钟设置，具有系统托盘集成、Windows Toast通知、屏幕视觉效果和完善的设置系统。
...
- **Pillow (10.0.0)**：图像处理（托盘图标渲染）
- **plyer (2.1.0)**：跨平台系统通知支持
